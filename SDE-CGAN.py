...
from utils.evaluation import plot_losses
from utils.evaluation import plot_gradiants, plot_distibuation_all, plot_err_histogram
...
def train(best_crps, ex_results_path):
    ...
    plot_gradiants(gen_gradients, critic_gradients, ex_results_path)

    return saved_model_path, generator, best_crps, runtime
...
if __name__ == '__main__':
    ...
    is_train = True
    if is_train:
        saved_model_path, trained_model, best_crps, runtime = train(best_crps, ex_results_path)
    else:
